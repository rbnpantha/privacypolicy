...
class AddressBookPrivacyPolicy extends Component {
  render() {
    return (
      <div className="text-left m-5">
        ...
        <p>
          Rabin Pantha built the AddressBook app as a Free app. This SERVICE is
          provided by Rabin Pantha at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at AddressBook unless
...
export default AddressBookPrivacyPolicy;
