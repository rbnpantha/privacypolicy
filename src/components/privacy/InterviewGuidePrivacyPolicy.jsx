...
class InterviewGuidePrivacyPolicy extends Component {
  render() {
    return (
      <div className="text-left m-5">
        ...
        <p>
          Rabin Pantha built the InterviewGuide app as an Ad Supported app. This
          SERVICE is provided by Rabin Pantha at no cost and is intended for use
          as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at InterviewGuide unless
...
export default InterviewGuidePrivacyPolicy;
